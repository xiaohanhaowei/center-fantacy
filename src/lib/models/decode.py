...
def multi_pose_decode(
  ...
  '''
    @param:
        heat:  [batch, category, input_height/down_ratio, input_width/down_ratio] where
              category is the number of the class of dataset. in multipose category =1 
        ...
        hp_offset      [b, 2, h, w]  "joint local offset" 
                                      In my opinion, this offset's function is to be compensate to
                                      the all joint's coordinate's down sample loss.
  ...
  if hm_hp is not None:
      ...
      # "min_ind" is the most important in the comparation criterion.  
